...
* recursive := TkNumber | TkFalse | TkTrue | TkNum | TkBool | TkId | TkAssign | TkColon | TkSemicolon | TkComma | TkQuote | TkNot | TkOpenPar | TkClosePar | TkOpenBracket | TkCloseBracket | TkOpenBrace | TkCloseBrace | TkOr | TkAnd | TkPower | TkDiv | TkPlus | TkMult | TkMod | TkMinus | TkLE | TkLT | TkGE | TkGT | TkEQ | TkNE 
* TkNumber := space* value = '-?[0-9]+(?:\.[0-9]+)?' next=recursive*
* TkNum := space* value = 'num' next=recursive*
* TkBool := space* value = 'bool' next=recursive*
...
export type recursive_28 = TkLT;
export type recursive_29 = TkGE;
export type recursive_30 = TkGT;
export type recursive_31 = TkEQ;
export type recursive_32 = TkNE;
