...
export type recursive_5 = TkId;
export type recursive_6 = TkAssign;
export type recursive_7 = TkColon;
export type recursive_8 = TkSemicolon;
export type recursive_9 = TkComma;
export type recursive_10 = TkQuote;
export type recursive_11 = TkNot;
export type recursive_12 = TkOpenPar;
export type recursive_13 = TkClosePar;
export type recursive_14 = TkOpenBracket;
export type recursive_15 = TkCloseBracket;
export type recursive_16 = TkOpenBrace;
export type recursive_17 = TkCloseBrace;
export type recursive_18 = TkOr;
export type recursive_19 = TkAnd;
export type recursive_20 = TkPower;
export type recursive_21 = TkDiv;
export type recursive_22 = TkPlus;
export type recursive_23 = TkMult;
export type recursive_24 = TkMod;
export type recursive_25 = TkMinus;
export type recursive_26 = TkLE;
export type recursive_27 = TkLT;
export type recursive_28 = TkGE;
export type recursive_29 = TkGT;
export type recursive_30 = TkEQ;
export type recursive_31 = TkNE;
    ...
    public matchstart($$dpth: number, $$cr?: ErrorTracker): Nullable<start> {
        return this.run<start>($$dpth,
            () => {
                ...
                if (true
                    && this.matchrecursive($$dpth + 1, $$cr) !== null
