...
export type terms = terms_1 | terms_2 | terms_3 | terms_4;
export type terms_1 = TkNumber;
export type terms_2 = TkBoolean;
export type terms_3 = TkId;
...
export class Parser {
    ...
    public matchTkNumber($$dpth: number, $$cr?: ErrorTracker): Nullable<TkNumber> {
        return this.run<TkNumber>($$dpth,
            () => {
                ...
                if (true
                    && ($scope$value = this.regexAccept(String.raw`(?:TkNumber\([0-9]+\) )`, $$dpth + 1, $$cr)) !== null
                ) {
        ...
        return this.run<assign>($$dpth,
            () => {
                ...
                if (true
                    ...
                    $$res = {kind: ASTKinds.assign, id: $scope$id, symbol: $scope$symbol, e: $scope$e};
                }
                return $$res;
            });
    }
        ...
        return this.run<array>($$dpth,
            () => {
                ...
                if (true
                    ...
                    && ($scope$e = this.matchtermino($$dpth + 1, $$cr)) !== null
    ...
    public matchterms_4($$dpth: number, $$cr?: ErrorTracker): Nullable<terms_4> {
    ...
    public matche8_2($$dpth: number, $$cr?: ErrorTracker): Nullable<e8_2> {
        return this.run<e8_2>($$dpth,
            () => {
                let $scope$value: Nullable<termino>;
                let $$res: Nullable<e8_2> = null;
                if (true
                    && this.matchTkOpenBracket($$dpth + 1, $$cr) !== null
                    && ($scope$value = this.matchtermino($$dpth + 1, $$cr)) !== null
